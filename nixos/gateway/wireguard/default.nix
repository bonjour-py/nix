{config, ...}:{
  age.secrets = {
    ...
    "wireguard/gateway-desktop.preshared" = {
      file = ./gateway-desktop.preshared.age;
      group = "systemd-network";
      mode = "640";
    };
    "wireguard/gateway-laptop.preshared" = {
  ...
  networking = {
    wireguard.interfaces.wireguard = {
      privateKeyFile = config.age.secrets."wireguard/gateway.private".path;
      listenPort = 51820;
      ...
      peers = [
        ...
        }
        {
          ...
          presharedKeyFile = config.age.secrets."wireguard/gateway-laptop.preshared".path;
          allowedIPs = ["192.168.59.251/32"];
        }
        {
          publicKey = "IMg+/XWKx2VVGzzoVN0Chtka5ZD6USwk6UnPL5I5SQM=";
          presharedKeyFile = config.age.secrets."wireguard/gateway-desktop.preshared".path;
